...
namespace ToboPasswords
{
    public class ToboPasswords
    {
        ...
        private static void EnterBank(string bank)
        {
            ...
            if (File.Exists(Get(bank)))
            {
                ...
                TryPass:;
                    ...
                    {
                        string[] lines = contents.Split(NewlineSplit, StringSplitOptions.RemoveEmptyEntries);
            ...
            while (Read(out input) == false)
            {
                ...
                List<string> split = new List<string>(ParseText(input, ' ', '\"'));
        ...
        {
            string[] split = contents.Split(NewlineSplit, StringSplitOptions.RemoveEmptyEntries);
            if (split.Length < 2)
                return -1;
